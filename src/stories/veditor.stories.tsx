...
import {createVEditor, genericVectorVEditor, Factory, StructEditorProps, FieldEditorProps, UnionEditorProps, UnimplementedEditorProps, MaybeEditorProps, VectorEditorProps, CustomContext, VEditorCustomize, FieldCustomize, } from "../lib/veditor/adlfactory";
...
storiesOf("VEditors", module)
  .add("String", () => {
    const veditor = createVEditor(adlrt.texprString(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Word16", () => {
    const veditor = createVEditor(adlrt.texprWord16(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Word16 (disabled)", () => {
    const veditor = createVEditor(adlrt.texprWord16(), RESOLVER, new VEditorFactory());
  ...
  .add("Bool", () => {
    const veditor = createVEditor(adlrt.texprBool(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Json", () => {
    const veditor = createVEditor(adlrt.texprJson(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Name", () => {
    const veditor = createVEditor(adlex.texprName(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  }) 
  .add("Person", () => {
    const veditor = createVEditor(adlex.texprPerson(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  }) 
  .add("Gender", () => {
    const veditor = createVEditor(adlex.texprGender(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  }) 
  .add("Hierarchy", () => {
    const veditor = createVEditor(adlex.texprHierarchy(), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Maybe<String>", () => {
    const veditor = createVEditor(adlsys.texprMaybe(adlrt.texprString()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Maybe<Word32>", () => {
    const veditor = createVEditor(adlsys.texprMaybe(adlrt.texprWord32()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Maybe<Person>", () => {
    const veditor = createVEditor(adlsys.texprMaybe(adlex.texprPerson()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })   
  .add("Nullable<String>", () => {
    const veditor = createVEditor(adlrt.texprNullable(adlrt.texprString()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Nullable<Word32>", () => {
    const veditor = createVEditor(adlrt.texprNullable(adlrt.texprWord32()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Nullable<Person>", () => {
    const veditor = createVEditor(adlrt.texprNullable(adlex.texprPerson()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor);
  })
  .add("Vector<Name>", () => {
    ...
    const veditor = createVEditor(adlrt.texprVector(adlex.texprName()), RESOLVER, new VEditorFactory());
  ...
  .add("Vector<Gender>", () => {
    ...
    const veditor = createVEditor(adlrt.texprVector(adlex.texprGender()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor, false, initial);
  })   
  .add("Vector<Person> (default)", () => {
    ...
    const veditor = createVEditor(adlrt.texprVector(adlex.texprPerson()), RESOLVER, new VEditorFactory());
    return renderVEditorStory(veditor, false, initial);
  })   
  .add("Vector<Person> (customized)", () => {
    ...
    const factory = new VEditorFactory();
